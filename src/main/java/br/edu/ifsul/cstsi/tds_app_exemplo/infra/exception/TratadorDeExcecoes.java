package br.edu.ifsul.cstsi.tds_app_exemplo.infra.exception;
...
/*
    Esta classe centraliza o tratamento de exceções do App.
    Não esqueça de adicionar a anotação @Valid nos controladores que estiver validando o Dto.
 */

@RestControllerAdvice //adiciona ao Contexto do app como um objeto que pré-processa a requisição antes do Controller
public class TratadorDeExcecoes {
    ...
    public ResponseEntity<ErroPadrao> handleValidationExceptions(MethodArgumentNotValidException ex, WebRequest request) {
        ...
        return build(HttpStatus.FORBIDDEN, "Erro de validação", errors, request);
    }
